...
STAGE = "robust" # clean_head | clean_finetune | robust
RUN_TRAIN = True
# ===============
...
# --------- run training for selected STAGE (if any)
if RUN_TRAIN:
...
lazy_losses = []
lazy_accs = []
for i in range(5): # statisctical evaluation -> Randomness in transforms for corruption
